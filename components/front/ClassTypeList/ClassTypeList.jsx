            ...
            {dropdownShow && <div className={style.inputDropDown}>
                <div className={style.radioArea}>
                    <div className="form-check d-flex justify-content-between ps-0">
                        ...
                        <input className="form-check-input" onClick={()=>setClassValue('ECONOMY')} type="radio" checked={classValue === 'ECONOMY' ? true : false} name="radio" id="rd-6" />
                    </div>
                </div>
                <div className={style.radioArea}>
                    <div className="form-check d-flex justify-content-between ps-0">
                        ...
                        <input className="form-check-input" onClick={()=>setClassValue('PREMIUM_ECONOMY')} checked={classValue === 'PREMIUM_ECONOMY' ? true : false} type="radio" name="radio" id="rd-7" />
                    </div>
                </div>
                <div className={style.radioArea}>
                    <div className="form-check d-flex justify-content-between ps-0">
                        ...
                        <input className="form-check-input" onClick={()=>setClassValue('BUSINESS')} checked={classValue === 'BUSINESS' ? true : false} type="radio" name="radio" id="rd-8" />
                    </div>
                </div>
                <div className={style.radioArea}>
                    <div className="form-check d-flex justify-content-between ps-0">
                        ...
                        <input className="form-check-input" onClick={()=>setClassValue('FIRST')} checked={classValue === 'FIRST' ? true : false} type="radio" name="radio" id="rd-8" />
                    </div>
                </div>
            </div> }
