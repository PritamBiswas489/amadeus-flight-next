                ...
                <section className={style.dashboard}>
                    ...
                    <div className={style.dashboardRight}>
                        <div className={style.dashboardRightInner}>
                            <h4>
                                <Image alt="" src={traveler} placeholder="traveler" width={20} height={20} /> Each user have a rank and depend on rank give a discount and
                                advantages
                            </h4>
                            ...
                            <div className={`${style.discoverLevels} ${style.whiteBox}`}>
                                ...
                                <p>
                                    Each stay counts towards your progress in the programmed. Once unlocked, your discounts and travel rewards are yours to keep forever. Where will
                                    you go next?
                                </p>
